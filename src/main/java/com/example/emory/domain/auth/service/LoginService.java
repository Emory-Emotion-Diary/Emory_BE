package com.example.emory.domain.auth.service;

import com.example.emory.domain.auth.domain.presentation.dto.request.LoginRequest;
import com.example.emory.domain.auth.domain.presentation.dto.response.TokenResponse;
import com.example.emory.domain.auth.exception.PasswordMismatchException;
import com.example.emory.domain.user.domain.User;
import com.example.emory.domain.user.domain.repository.UserRepository;
import com.example.emory.domain.user.exception.UserNotFoundException;
import com.example.emory.global.security.jwt.JwtTokenProvider;
import com.example.emory.infrastructure.xquare.XquareClient;
import com.example.emory.infrastructure.xquare.dto.XquareUserResponse;
